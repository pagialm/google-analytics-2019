...
import * as strings from "GoogleAnalytics2019ApplicationCustomizerStrings";

const LOG_SOURCE: string = "GoogleAnalytics2019ApplicationCustomizer";
 ...
 */
export interface IGoogleAnalytics2019ApplicationCustomizerProperties {
...
export default class GoogleAnalytics2019ApplicationCustomizer extends BaseApplicationCustomizer<IGoogleAnalytics2019ApplicationCustomizerProperties> {
  private currentPage = "";
